...
--5 
UPDATE EMP SET EMP_AREACODE = '905' WHERE EMP_NUM = '108' or EMP_NUM = '107';

--6
SELECT EMP_NUM,EMP_AREACODE FROM EMP WHERE EMP_NUM < 110;

--7 
SELECT EMP_NUM, EMP_LNAME, EMP_FNAME, EMP_DOB FROM EMP ORDER BY EMP_DOB DESC;

--8
SELECT EMP_NUM, EMP_AREACODE, EMP_PHONE FROM EMP ORDER BY EMP_AREACODE, EMP_PHONE;


--9
SELECT * FROM EMP WHERE EMP_FNAME = 4;

--10
SELECT * FROM EMP WHERE LEN(EMP_FNAME) = 4; 

--11
SELECT * FROM EMP WHERE EMP_LNAME < EMP_FNAME ORDER BY EMP_LNAME;

--12
SELECT * FROM P WHERE V_CODE IS NULL; 

--13
SELECT EMP_LNAME, EMP_LNAME, EMP_HIRE_DATE;